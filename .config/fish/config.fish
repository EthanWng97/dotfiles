...
alias update "brew update && brew upgrade && brew cu && brew cleanup && ncu -u -g && pip3 list --outdated --format=freeze | grep -v '^\-e' | cut -d = -f 1 | xargs -n1 pip3 install -U | fisher update"
alias nv "nvim"
